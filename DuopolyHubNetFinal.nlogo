  ...
  ask sellers [
    ...
    [ ifelse strategy = "Quota-Plus"
      [ set price-1 monopoly-price
        ...
        set p2-quantity-offered extra-output ;print word "set p2 offered extra-output" p2-quantity-offered
       ]
...
;       ]
   ...
   set p2-quantity-available p2-quantity-offered ;print word "p2-quantity-available" p2-quantity-available
